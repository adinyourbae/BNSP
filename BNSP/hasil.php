            ...
            <main class="min-vh-100 d-flex flex-column justify-content-center align-items-center p-5">
                <div class="table-responsive p-5 bg-light">
                    ...
                    <blockquote class="blockquote fs-6">
                        <p>Jenis Kelamin</p>
                        <ul>
                            <li>Kelamin/L = Laki - Laki </li>
                            <li>Kelamin/P = Perempuan</li>
                        </ul>
                    </blockquote>
                    <table class="table table-hover table-bordered table-striped">
                        <!-- `nama`, `email`, `no_hp`, `jenis_kelamin`, `semester`, `last_ipk`, `beasiswa`, `syarat_berkas` -->
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary"
                                        href="functions/download.php?filename=<?php echo $row["syarat_berkas"]; ?>">
