...
<body class="bg-secondary">
    <div class="container">
        ...
        <main class="min-vh-100 d-flex flex-column justify-content-center align-items-center">
            <form class="form bg-light p-3" action="" method="POST" class="form needs-validation"
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" name="nomor_hp" id="nomor_hp" aria-describedby="no_hp"
                        required>
                </div>
                <div class="mb-1">
                ...
                <div class="mb-1">
                    ...
                    <select class="form-select" disabled id="beasiswa" name="beasiswa"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" accept="application/pdf, .doc, .docx, .zip" type="file" disabled
...
if (isset($_POST['submit'])) {
    ...
    if ($nama == '' || $email == '' || $nomorhp == '' || $jenis_kelamin == '0' || $semester == '' || $ipk == '' || $berkas == '') {
        ...
        // Input semua data ke database, termasuk jenis kelamin
        $sql = "INSERT INTO daftar (nama, email, no_hp, jenis_kelamin, semester, last_ipk, beasiswa, syarat_berkas, status_ajuan) VALUES ('$nama', '$email', '$nomorhp', '$jenis_kelamin', '$semester', '$ipk', '$beasiswa', '$berkas', '$status')";
        // Cek koneksi
